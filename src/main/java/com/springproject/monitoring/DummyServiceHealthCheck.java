package com.springproject.monitoring;
...
public class DummyServiceHealthCheck implements HealthIndicator {
    ...
    public Health health()
    {
        try {
            if (isServiceUp()) {
                return Health.up().withDetail("My other dummy Service", "is up an running").build();
            } else {
                return Health.down().withDetail("My other dummy  Service", "is DOWN").build();
            }
        }
